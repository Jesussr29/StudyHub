...
import { VscAccount, VscLibrary, VscHome, VscFolder   } from 'react-icons/vsc';
        ...
        <header className="relative bg-[#02040b] text-white shadow-md">
            ...
            >
                ...
                <div className="flex w-full flex-col justify-between bg-[#0d111a] px-6 py-10 md:w-1/2">
                    {/* Botones superiores */}
                    <div className="mb-10 mb-40 flex flex-col items-start gap-4 md:mb-10 md:flex-row hidden md:block">
